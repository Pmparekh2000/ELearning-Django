...
class ItemBase(models.Model):
    ...
    def render(self):
        ...
        # The "self._meta.model_name" generates the appropriate template name to be rendered
        # The above function renders a template and renders the data in the form of string
